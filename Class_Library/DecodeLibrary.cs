...
namespace Class_Library
{
    public class DecodeLibrary
    {
        ...
        {
            string Character = "";
            string bit1 = Convert.ToString(Six_bit_Message[0]);
            string bit2 = Convert.ToString(Six_bit_Message[1]);
            string bit3 = Convert.ToString(Six_bit_Message[2]);
            string bit4 = Convert.ToString(Six_bit_Message[3]);
            string bit5 = Convert.ToString(Six_bit_Message[4]);
            string bit6 = Convert.ToString(Six_bit_Message[5]);
            ...
            if (bit4 + bit3 + bit2 + bit1 + bit6 + bit5 == "000010") { Character = "SP"; }
