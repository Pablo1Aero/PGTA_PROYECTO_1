...
2. Click the Right Icon and wait for the file to be read.

3. Once the reading has been completed:	- Select Show Data Table to view all Asterix Messages with its corresponding data items.
